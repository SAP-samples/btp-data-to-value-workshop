# Data Preparation for SAP BTP Data-to-Value Workshop
...
- [data preparation via sql](01-bookshop-hcs/sql): Creating table structures and import the data via SQL. This approach will be used in our workshop for simplicity. Please follow this document step by step to prepare the bookshop data via sql.
